...
import F_UserVideoComponent from './F_UserVideoComponent';
...
class F_OpenViduComponent extends Component {
    constructor(props) {
        super(props);
                    ...
                    <div id="session">
                        ...
                        {this.state.mainStreamManager !== undefined ? (
                            <div id="main-video" className="col-md-6">
                                <F_UserVideoComponent streamManager={this.state.mainStreamManager} />
...
export default F_OpenViduComponent;